...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO jobs (comp_name, comp_location, comp_description, job_summary, job_type, job_experience, job_employmenttype) VALUES ('$comp_name', '$comp_location', '$comp_description', '$job_summary', '$job_type', '$job_experience', '$job_employmenttype')";
...
<body>
    ...
    <nav class="navbar navbar-expand-sm" style="font-weight: 500;">
      <div class="container-fluid">
        <a class="navbar-brand text-primary" href="home-user.html">JobHub</a>
          ...
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a class="dropdown-item" href="home-guest.html">Sign Out</a></li>
              </ul>
            </li>
          </ul>
        </div>
